...
from .trending.tool import get_trending_topics
from .profile.tool import get_user_profile
from .arxiv_related.tool import find_related_papers
...
TOOL_FUNCTIONS = {
    ...
    "arxiv_related": find_related_papers,
